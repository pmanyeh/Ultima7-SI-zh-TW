...
labelFunc0464_001B:
	...
	message("「我是這裡的教官，探求者。我的任務是在測試開始前，先判斷你的道德( Ethicality )已經進展到了哪個程度。」");
	say();
	message("「你希望開始測試嗎？」");
	say();
...
labelFunc0464_007A:
	...
	message("「你答對了。道德要求你必須像珍視自己的生命一樣，去尋求保護他人的生命。」 *「沒有人的命運在他活著時是注定的。你的行動可以改變命運的走向…」");
	say();
	UI_push_answers();
	message("「第二題：如果你在一棟不知道主人是否還在的建築物裡，發現了一個堆滿了無盡財富的房間，如果你急需錢財，取走這些錢是否合乎道德？還是你會將這些錢留在那裡，即使它可能被用於邪惡的目的？」");
	say();
	UI_add_answer(["取走錢財", "留下錢財"]);
labelFunc0464_009E:
	case "取走錢財" attend labelFunc0464_00B1:
	message("「探求者，無論多麼需要，道德要求你，不得在未經允許的情況下，取走任何東西。有時這些事情很難取得平衡，但隨著時間的推移，你會發現這件事越來越容易…」");
	say();
	UI_pop_answers();
	goto labelFunc0464_0169;
labelFunc0464_00B1:
	case "留下錢財" attend labelFunc0464_00D2:
	message("「你答對了，探求者。你根本不知道這些錢是要用來做什麼的。」 *「道德要求你不得在未經允許的情況下取走任何東西，無論多麼需要。如果你想對他人做出評判，你自己的倫理性必須無懈可擊。」");
	say();
	UI_push_answers();
	message("「最後，第三題：如果你確定將死於一個不道德之人之手，你會向他屈服以求保命嗎？還是道德要求你應該繼續戰鬥，直到死亡？」");
	say();
...
labelFunc0464_00ED:
	...
	message("「你答對了，而且你也很勇敢，探求者。你知道向邪惡屈服就是承認那惡的統治。」 *「道德要求你維護自己的美德，對抗邪惡，即使是以犧牲生命為代價。」");
	say();
	message("「你回答得很好…在所有的美德中，道德往往是最主觀、最難以把握的。」 *「你已值得接受測試了…」");
	say();
	UI_pop_answers();
	UI_pop_answers();
