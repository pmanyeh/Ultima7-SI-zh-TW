...
labelFunc041D_016D:
	...
	message("「你拿到了血苔！太棒了！」");
	say();
	message("「做為回報，我將告訴你如何與 Erstam 對話的方法。」");
	say();
...
labelFunc041D_0353:
	...
	message("「雖然我確實是一名法師，但我不是高階法師(Adept)。而且 Filbercio 的規矩是只邀請高階法師參加他的宴會。」");
	say();
	UI_add_answer(["Filbercio", "高階法師"]);
labelFunc041D_0373:
	case "Filbercio" attend labelFunc041D_0399:
	UI_remove_answer("Filbercio");
	message("「Filbercio 是領主法師！當你在月影城時，最好別忘了這一點。」");
	say();
...
labelFunc041D_03E2:
	...
	say();
labelFunc041D_0403:
	case "高階法師" attend labelFunc041D_0424:
	UI_remove_answer("高階法師");
	message("「魔法有不同的能力等級，");
	message(var0000);
	message("。這全都取決於你能施展什麼等級的法術。」");
	say();
	message("「我自己只能掌握第三環的法術。而高階法師(Adept)能掌握第九環的法術。」");
	say();
	message("「只有高階法師(Adept)才能成為領主法師，或者進入法師議會。所以我靠賣施法材料給高階法師們為生。」");
	say();
labelFunc041D_0424:
...
labelFunc041D_0542:
	...
	UI_remove_answer("力量");
	message("「嗯，準確地說，我應該說她懷疑最近的一位訪客——一個名叫巴特林的法師。」");
	say();
...
labelFunc041D_05BE:
	...
	message("「Fedabiblio 管理著月影城的圖書館。所有的資訊，無論是歷史還是魔法方面的，最終都會落到他手裡。」");
	say();
...
labelFunc041D_066F:
	...
	message("「Mortegro 是一位專注於與死者交談的高階法師(Adept)。他不會強迫他們服務或什麼的，只是和他們交談。」");
	say();
...
labelFunc041D_084B:
	...
	message("「Erstam 曾是大多數高階法師(Adepts)的導師。據說他是個嚴厲的大師。」");
	say();
	message("「流傳的故事是， Erstam 永遠不會承認他的任何學生有資格被稱為高階法師(Adept)。顯然，他想盡可能長久地榨取這些免費勞動力。」");
	say();
...
labelFunc041D_0894:
	...
	message("「如果要說誰是月影城的核心，我很難說出是 Bucia 還是 Rocco 。」");
	say();
...
labelFunc041D_08B2:
	...
	say();
	message("「Rocco 會從那些喝得爛醉、不在乎對誰說了什麼的人那裡收集八卦。所以，有 Bucia 和 Rocco 兩人，他們幾乎聽遍了月影城發生的一切。」");
	say();
labelFunc041D_08C9:
...
labelFunc041D_09FF:
	...
	say();
	message("「你知道擁有那塊石頭是被禁止的嗎？你知道有些高階法師(Adepts)願意花多少錢買那塊石頭產生的施法材料嗎？」");
	say();
...
labelFunc041D_0A64:
	...
	say();
	message("「然後你必須把血用在石心上。這會產生你施展死亡法術所需的血菌絲。你必須非常小心。它非常強大。」");
	say();
labelFunc041D_0A7F:
	case "告辭" attend labelFunc041D_0AD2:
	UI_remove_npc_face0();
