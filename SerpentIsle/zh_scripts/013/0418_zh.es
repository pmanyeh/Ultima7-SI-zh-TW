...
labelFunc0418_039E:
	...
	say();
	message("「他對細節很有眼光，即便是對僕人這種低下的創造物也是如此。你可以在藍野豬旅店看到他最傑出的作品——他讓 Rocco 在那裡展示 Petra 。」");
	say();
	UI_add_answer(["藍野豬旅店", "Rocco", "Petra"]);
labelFunc0418_03C5:
	case "藍野豬旅店" attend labelFunc0418_03D8:
	UI_remove_answer("藍野豬旅店");
	message("「藍野豬旅店是月影城唯一一家餐廳。因此，不幸的是，它同時服務法師和凡夫俗子。如果你夠有耐心，你可能會在那裡遇到許多其他法師。」");
	say();
labelFunc0418_03D8:
	case "Rocco" attend labelFunc0418_03EF:
	UI_remove_answer("Rocco");
	message("「Rocco 是 藍野豬旅店的凡夫俗子旅館老闆。他是個脾氣暴躁的粗漢。不過我去那裡不是為了聽他說話…只是為了他的食物。」");
	say();
...
labelFunc0418_03EF:
	...
	say();
	message("「我認為 Petra 出現在藍野豬旅店，對 Torrissio 的名聲有很大的幫助…」");
	say();
labelFunc0418_0406:
