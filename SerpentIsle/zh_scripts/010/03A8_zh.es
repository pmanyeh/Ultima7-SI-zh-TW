...
void Func03A8 shape#(0x3A8) ()
{
	...
	if (!(event == 0x0002)) goto labelFunc03A8_0083;
	var0000 = UI_get_object_position(item);
	var0001 = UI_get_item_quality(item);
	var0002 = UI_get_item_frame(item);
	if (!(var0002 <= 0x0004)) goto labelFunc03A8_0033;
	var0002 = 0x0000;
	goto labelFunc03A8_004C;
labelFunc03A8_0033:
	if (!(var0002 >= 0x000A)) goto labelFunc03A8_0046;
	var0002 = 0x0002;
	goto labelFunc03A8_004C;
labelFunc03A8_0046:
	var0002 = 0x0001;
labelFunc03A8_004C:
	...
	if (!var0003) goto labelFunc03A8_0082;
...
labelFunc03A8_0082:
	abort;
labelFunc03A8_0083:
	if (!(event == 0x0001)) goto labelFunc03A8_0093;
