...
labelFunc03B3_004A:
	...
	say();
	message("「我不是什麼大人，陌生人。我只是一名戰士。你可以稱呼我的名字或頭銜。我是副指揮官 Tsandar。」");
	say();
...
labelFunc03B3_00FF:
	...
	message("「當我被分配到這個駐軍時，我是資深隊長。然後，九個月前，當那些混沌的惡魔帶走 Ardiniss 指揮官時，我被任命為駐軍指揮官。」");
	say();
	message("「自然地，現在 Isstanar 來了，我就成了副指揮官。」");
	say();
	UI_add_answer(["資深隊長", "混沌的惡魔", "Ardiniss 指揮官", "Isstanar"]);
labelFunc03B3_0129:
	case "資深隊長" attend labelFunc03B3_0149:
	UI_remove_answer("資深隊長");
...
labelFunc03B3_0149:
	...
	UI_remove_answer("階級");
	message("「一名資深戰士指揮一手(五人)的戰士，並向初級隊長報告。」");
	say();
	message("「一名初級隊長負責兩手的戰士，並向隊長(File Leader)報告。」");
	say();
	message("「一名隊長監督四手的戰士，並向資深隊長報告。」");
	say();
	message("「一名資深隊長控制十手的戰士，並向駐軍的副指揮官報告。副指揮官則是駐軍指揮官的副手。」");
	say();
labelFunc03B3_0168:
...
labelFunc03B3_017B:
	...
	say();
labelFunc03B3_018E:
	case "Ardiniss 指揮官" attend labelFunc03B3_01BC:
	UI_remove_answer("Ardiniss 指揮官");
	message("「 Ardiniss 指揮官是個勇敢的人，");
	message(var0001);
	message("。他負責在充滿敵意的混沌領地中開闢出這座堡壘。」");
	say();
	message("「沒有任何戰士的邏輯思維能比得上指揮官。然而，即使是邏輯也敵不過那天湧向我們的龐大數量的混沌信徒……」");
	say();
	message("「我很遺憾我們沒能從那些卑鄙的殺人兇手手中搶回他的遺體。 Ardiniss 理應獲得一場適當的戰士葬禮。」");
	say();
...
labelFunc03B3_020E:
	...
	say();
	message("「在那些……那些……混沌的怪物謀殺了大祭司之後，這片土地的統治權自然就落到了秩序手中。我們會讓他們所有人為自己的罪行付出代價！」");
	say();
	UI_add_answer("大祭司");
labelFunc03B3_022C:
	case "大祭司" attend labelFunc03B3_0251:
	UI_remove_answer("大祭司");
	message("「 Ssithnos 是最後一任大祭司，");
	message(var0001);
	message("。他在我還是個孩子時被謀殺了，距今已經超過三手(十五)年了。」");
	say();
	message("「大祭司是大地巨蛇(Great Earth Serpent)的代言人……只有大地巨蛇的旨意才能壓制秩序與混沌之間的敵意。」");
	say();
	message("「只有大祭司的智慧維持了這片土地的平衡。最後幾位平衡學徒(Acolytes of Balance)偷偷運走了 Ssithnos 的遺體，而秩序的戰士們則發誓要向混沌復仇……」");
	say();
...
labelFunc03B3_0251:
	...
	say();
	message("「但虛空中發生了什麼事……我不知道是什麼。我們再也感受不到大地巨蛇的力量，我們也不再有 Ssithnos 的智慧來引導我們。」");
	say();
...
labelFunc03B3_02E0:
	...
	say();
	message("「但是現在我們有了魔導人偶，沒有什麼能阻擋我們了！死亡守望曾位於衝突的矛頭上……現在我們守護的是撤退的防線。」");
	say();
	message("「我只希望，我們能知道的比 Isstanar 指揮官，幾週前那時告訴我們的更多。」");
	say();
	UI_add_answer(["魔導人偶", "死亡守望"]);
labelFunc03B3_0308:
	case "魔導人偶" attend labelFunc03B3_031F:
...
labelFunc03B3_034B:
	...
	message("「秩序戰士的典範，");
	message(var0001);
	message("！ Isstanar 已經拋棄了肉體的煩惱，換上了魔導人偶的軀體！」");
	say();
...
labelFunc03B3_0373:
	...
	message("「我不知道這是怎麼做到的。這是秩序教長和最高指揮部嚴格保守的秘密。如果你想知道，可以去問 Isstanar ，但我懷疑他會不會告訴你任何事。」");
	say();
...
labelFunc03B3_038A:
	...
	say();
	message("「也許我該派你去和 Surok 談談。他是我們這裡最接近知識守護者(Keeper of Knowledge)的人。我可以告訴你我所知道的，但我怕那對你沒什麼用。」");
	say();
	UI_add_answer(["預言中的戰士", "Surok"]);
labelFunc03B3_03AE:
	case "預言中的戰士" attend labelFunc03B3_03D0:
	UI_remove_answer("預言中的戰士");
	message("「當大祭司遇害時，這片土地上流傳著一個故事，說會有一位戰士挺身而出，為 Ssithnos 的死報仇。」");
	say();
	message("「你戴的護身符只有平衡鬥士才能戴。我不知道如果你不是被選中的鬥士，怎麼可能戴上它還能活著。」");
	say();
	message("「但我不明白，如果你是被選中的鬥士，你怎麼會不知道自己的職責。這真是太令人費解了……我的邏輯似乎無法處理這件事。去和 Isstanar 或 Surok 談談吧。」");
	say();
	UI_add_answer("平衡鬥士");
labelFunc03B3_03D0:
	case "平衡鬥士" attend labelFunc03B3_03E7:
	UI_remove_answer("平衡鬥士");
	message("「在我們人民的歷史中，曾有一段時期，一群不信者拒絕接受大祭司的權威。」");
	say();
...
labelFunc03B3_03E7:
	...
	message("「 Surok 是我們的治療師。他很老了，我擔心他的決心正在動搖。他還沒有玩忽職守過，但我已經建議 Isstanar 密切注意他。」");
	say();
...
labelFunc03B3_040B:
	...
	message("「 Surok 年輕時也是個無所畏懼的戰士，同時也是個治療師。這無疑是他衰老的跡象，但他似乎……嗯，對我們事業的正確性不再那麼確定。」");
	say();
...
labelFunc03B3_0422:
	...
	say();
	message("「我當時立刻想到，這隻生物可能是混沌用來對付我們魔導人偶的武器。所以我把那野獸帶給 Surok 解剖。」");
	say();
	message("「當然，我沒有證據，否則我就去找 Isstanar 了。但我相信 Surok 對那隻野獸動了惻隱之心，並讓它逃走了。」");
	say();
...
labelFunc03B3_0448:
	...
	message("「建築師 Issik 在戰爭開始前來到了堡壘。他的職責是建造一座不可能破解的迷宮，以保護秩序的寶藏。」");
	say();
	message("「但當戰爭爆發時，Issik 被告知他只有三個月的時間來完成這項工作。沒有人知道他後來怎麼了，因為他再也沒有出來。」");
	say();
