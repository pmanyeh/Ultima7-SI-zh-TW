...
labelFunc03B1_004F:
	...
	say();
	message("「我是 Isstanar ，巨蛇之牙(Serpent's Fang)及其駐軍的指揮官。」");
	say();
...
labelFunc03B1_011C:
	...
	message("「難道你不知道復仇者 Calithiss 和我們的神聖十字軍(holy crusade)？」");
	say();
...
labelFunc03B1_014A:
	...
	message("「在失衡之戰(War of Imbalance)開始之前，Calithiss 被稱為堅定者(the Steadfast)。但在 Ssithnos 被卑鄙地謀殺後，她自稱為復仇者(the Avenger)。」");
	say();
	UI_push_answers();
	UI_add_answer(["失衡之戰", "Ssithnos", "沒什麼了"]);
labelFunc03B1_0171:
	...
	say();
	message("「但，總是會有少數人，被召喚去為所有蛇神教徒(Ophidians)服務，他們追隨大祭司(Great Hierophant)。但是混沌的信徒殺了最後一任大祭司，讓這片土地陷入戰爭，因為再也沒有人能維持平衡了。」");
	say();
	UI_add_answer(["閃耀之路", "蛇神教徒"]);
labelFunc03B1_019B:
	case "閃耀之路" attend labelFunc03B1_01B6:
	UI_remove_answer("閃耀之路");
	message("「你是在測試我的知識嗎，平衡鬥士？你以為會發現像我這般地位的秩序戰士有所不足嗎？」");
	say();
	message("「我不是平衡的信徒，但連我也知道，只有大祭司能安全地進入虛空(Void)與巨蛇交流，他走在閃耀之路上以接受祂們的智慧。」");
	say();
	message("「所有其他膽敢冒險進入虛空的人，都沒有道路能指引他們，注定會因為他們的傲慢而死。」");
	say();
labelFunc03B1_01B6:
	case "蛇神教徒" attend labelFunc03B1_01DB:
	UI_remove_answer("蛇神教徒");
	message("「你的問題真令人困惑，");
	message(var0001);
	message("。你是平衡鬥士，卻問一些所有人都知道的事情…」");
	say();
	message("「你是想知道自 Ssithnos 死後我們墮落了多少嗎？那麼你可以從我這個秩序的終極戰士身上來評判秩序。」");
	say();
	message("「我們是蛇神教徒，平衡、秩序以及，唉，混沌的信徒。我們尊崇居住在虛空中的巨蛇，因為引導我們所有人的正是祂們的智慧。」");
	say();
	message("「看吧，你看到了秩序並沒有忘記教誨。這就是為什麼秩序必須在這場戰爭中獲勝。混沌的惡魔殺了大祭司。偏離正道的是他們，不是秩序。」");
	say();
labelFunc03B1_01DB:
	case "Ssithnos" attend labelFunc03B1_0208:
	UI_remove_answer("Ssithnos");
	message("「 Ssithnos 是最後一任大祭司。他是個神聖的人，");
	message(var0001);
	message("。大地巨蛇(Great Earth Serpent)的智慧在他身上閃耀。」");
	say();
	message("「當我還是個年輕的戰士時，有幸在紀律神殿(Temple of Discipline)見過他一次。那是在他遭遇悲慘結局的很久之前。」");
	say();
...
labelFunc03B1_0208:
	...
	say();
	message("「如果大祭司死了，身為平衡鬥士的你，還有什麼希望恢復平衡呢？沒有他來傳達大地巨蛇的旨意，你怎麼可能成功？」");
	say();
	UI_push_answers();
...
labelFunc03B1_02B7:
	...
	message("「我並不總是像你現在看到的這個樣子。我花了一輩子的時間，才配得上這份榮譽。」");
	say();
	UI_add_answer("榮譽");
labelFunc03B1_02D1:
	case "榮譽" attend labelFunc03B1_02EB:
	UI_remove_answer("榮譽");
	message("「我曾經和你一樣是有血有肉的秩序戰士。在戰爭開始前不久，我被選中接受考驗。」");
	say();
	UI_add_answer("考驗");
labelFunc03B1_02EB:
...
labelFunc03B1_0306:
	...
	say();
	message("「這座神殿是我們在這場該死戰爭中主要的集結和訓練區。它是最高指揮部的總部。」");
	say();
	UI_add_answer("最高指揮部");
labelFunc03B1_032A:
...
labelFunc03B1_0341:
	...
	message("「混沌的信徒破壞了教誨，讓這片土地陷入戰爭。是他們謀殺了大祭司。也是他們殺害了數以千計愛好和平的秩序信徒。」");
	say();
	message("「混沌的信徒必須為他們的罪行負責。沒有大祭司來監督正義，因此這責任落到了秩序的肩上，必須以血還血，直到混沌向秩序屈服，並且恢復平衡。」");
	say();
	UI_add_answer("教誨");
labelFunc03B1_035F:
	case "教誨" attend labelFunc03B1_037A:
	UI_remove_answer("教誨");
	message("「在 Ssithnos 被謀殺之前，這片土地在平衡中繁榮發展。秩序和混沌各自知道自己的職責，以及在生命體系中的位置。雙方是平等的，並受到大祭司權威的制衡。」");
	say();
	message("「所有人都被教導，一直以來都是如此，而且必須保持如此。那是大地巨蛇的旨意，好讓所有人都能享受平衡所帶來的和平恩賜。」");
	say();
	message("「但是大祭司被謀殺了，現在沒有和平了。沒有恩賜…只有戰爭和流血。是混沌把我們帶到了這個十字路口，而且他們必須付出代價。」");
	say();
labelFunc03B1_037A:
...
labelFunc03B1_039C:
	...
	say();
	message("「眾所周知，這片神聖的土地是所有大祭司最後的安息之地…雖然我不知道可憐的 Ssithnos 是否也是如此。」");
	say();
...
labelFunc03B1_03D9:
	...
	say();
	message("「要獲得這些法珠，就得靠你克服這個區域的種種危險。如果你能在這些嘗試中存活下來，我也會更傾向於相信你就是平衡鬥士。」");
	say();
...
labelFunc03B1_0401:
	...
	say();
	message("「當大祭司被謀殺時，存在了無法追溯時間之久的平衡之樹枯萎凋零了。一旦我們徹底擊潰混沌，復仇者 Calithiss 將會改用一個新的名字——復興者(the Renewer)，並種下這顆種子，讓平衡能治癒我們的土地。」");
	say();
labelFunc03B1_0418:
	...
	say();
	message("「我唯一能告訴你的是，你應該在這座堡壘附近的區域尋找法珠。它們散落得很廣…而且，小心點，那些區域很危險。」");
	say();
	UI_add_answer("危險");
labelFunc03B1_043C:
	...
	say();
	message("「還有一個廢棄的前哨站，被認為被混沌生物所佔據。當然，還有那座未完工的迷宮…建築師 Issik 進去後，就再也沒有回來揭開它內部的秘密。」");
	say();
...
labelFunc03B1_04E6:
	...
	say();
	message("「當我做出最終犧牲時，Calithiss 說：『把這個交給");
	message(var0002);
	message("來治癒我們土地的人。』」");
	say();
...
labelFunc03B1_0520:
	...
	message(var0001);
	message("。之所以如此命名，是因為這裡曾經是秩序，對混沌發動攻擊時的堡壘。」");
	say();
	message("「我所接替的 Ardiniss 指揮官，是一位出色的戰術家。在這場戰爭中迄今為止最血腥的一些戰鬥裡，他堅守住了這座堡壘及其周遭。也是在那段時間，戰士們開始稱這座堡壘為死亡守望(DeathWatch)。」");
	say();
	message("「隨著戰局的扭轉，失去 Ardiniss 是一個沉重的打擊。現在，巨蛇之牙負責守護撤退的防線，而不是戰爭的前線，而死亡守望也具有了另一層意義…守望著混沌的覆滅。」");
	say();
labelFunc03B1_0541:
