...
labelFunc031D_0115:
	...
	message("每個人都在尋找幼鹿城女士( The Lady of Fawn )。因為女士從黎明起就失蹤了。在整個城市裡吠叫著他們奇怪的曲調，所有人，鎮民和牧師。Iolo 做的，享受著這樣的盛宴。聖者，這不漂亮嗎？~~");
	say();
	message("      Iolo");
	say();
	goto labelFunc031D_0A44;
...
labelFunc031D_013F:
	...
	message("Kylista 必須和你談談，聖者，這就很有趣了…她之前還在和神諭通訊，現在她卻需要你。這種心意的改變有什麼隱含的意義嗎？你應該知道答案，聖者。當一個女人需要跟像你這樣的人說話時，你不會希望她等的，聖者，難道你會嗎？有什麼我們該注意的事嗎？~ 你親愛的老朋友 Iolo 想知道，聖者…");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0150:
	if (!(var0003 == 0x0009)) goto labelFunc031D_016F;
	message("  前往造幣廠；在那裡伏擊聖者。任務成功，你將獲得豐厚的獎勵。任務失敗只有一個懲罰——死亡！");
	say();
	message("~  記住，聖者經常和被詛咒的同伴一起旅行，他們可能會和");
	message(var0001);
	message("在一起。無視其他人——將你的精力集中在一個目標：毀滅聖者！銷毀這張紙條。~");
	say();
...
labelFunc031D_0188:
	...
	message("極富冒險精神的聖者：~");
	say();
	message("   我向你致以問候，聖者，送上我的祝福，並讓你知道，看來你並沒有適當注意我留下的線索。");
	say();
...
labelFunc031D_01B2:
	...
	message("向你致以秩序的問候，我極好的讀者！~~ 請注意，當美德處於不平衡狀態時，一個全新的系統就會開始運作。缺乏秩序力量( Order Forces )的混亂力量( Chaos Forces )會創造出混亂反力量( Chaos Anti-Forces )。我希望你了解這種改變意味著什麼。~ 像缺乏道德( Ethicality )的寬容( Tolerance )會造成行為標準的缺失，毫無疑問會導致無序( Anarchy )。~ 缺乏紀律( Discipline )的熱情( Enthusiasm )意味著缺乏自我克制的行為，那就是放縱( Wantonness )。~ 缺乏邏輯( Logic )的情感( Emotion )會助長無法以理性思考克服情感衝動的情況，這預示著瘋狂( Insanity )。~~");
	say();
...
labelFunc031D_0213:
	...
	message("魔法指南針( Magic Compass )~~據說這是瘋狂法師 Erstam 在航向巨蛇之島時所使用的傳奇神器。 ~ 要使用它，你必須將指南針放在地上，然後吟唱力量之語( mantra )『Yleg Ort』。 ~根據傳說，指南針會為你指明旅行的方向，但前提是你要有資格。~~至於我自己，我從來沒辦法讓這個該死的東西運作。因此，我把它捐給了魔法學院( Seminarium )。~~法師領主 Filbercio");
	say();
	gflags[0x012A] = true;
	goto labelFunc031D_0A44;
labelFunc031D_0228:
...
labelFunc031D_02A2:
	...
	message("ERAX 的日記~~");
	say();
	message("只有我設法安全回到了地面。我那傲慢的好奇心差點毀了我。沼澤下方洞穴中廢棄的蛇神教徒( Ophidian )建築非常危險。我的同伴死於不死生物的攻擊。任何僧侶( monk )都不該再回到那裡。我拿走了打開通往該區域大門的鑰匙，並把它藏在沼澤廢墟東南部附近空心的樹裡。我祈禱永遠不要有人找到那把鑰匙…");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_02B7:
...
labelFunc031D_0442:
	...
	say();
	message("記住，我選擇你是因為你是目前我能獲得的最好武器。別搞錯了，聖者不是一個容易的目標，而且絕對是你遇過最具挑戰性的。");
	say();
	message("盡快處理掉聖者。銷毀這張紙條。不要留下任何證據。");
	say();
	message("X");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0463:
	...
	message("我最親愛的：~~ 懇請妳原諒我昨晚的行為。這個聖者帶來的困難擾亂了我的表現，但我向妳保證，一旦我們處理掉");
	message(var0001);
...
labelFunc031D_0574:
	...
	say();
	message("較不暴力的時代繁榮發展，我只能懇求你幫忙將平衡( Balance )帶回到巨蛇之島！我必須在這裡結束這簡短的解釋，因為我已經聽到攻擊者在樓下猛敲橡木門的聲音。我祝你和你的世界比我擁有更好的運氣。~~ —— Ssithnos，大祭司( Great Hierophant )");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_05C1:
	if (!(var0003 == 0x0064)) goto labelFunc031D_05D2;
	message("我親愛的 Rotoluncia：~~ 我知道妳對我的信有什麼感覺，但我情不自禁——我日日夜夜都在想妳！妳是我悲慘生命中的光芒。妳就像太陽，讓所有注視妳美貌的人都眼盲。妳的嘴唇比最甜美的果實還要誘人。妳的肌膚比最美麗的玫瑰還要光滑。妳是女性的精華；沒有人能超越妳！~ 拜託，我懇求妳，說妳願意成為我的！~~ 焦急地等待妳的回覆…~~ 愛妳的 Filbercio");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_05D2:
...
labelFunc031D_05F1:
	...
	message("Rotoluncia：~~ 昨晚在宴會上，我看到妳盯著 Torrissio 那隻豬看，我現在知道妳對我表現出的感情是虛假的。妳是一頭母牛，也是一個破爛的法師！~ 別想假裝不是這樣，因為我現在知道真相了。我再也不想從妳那裡得到任何東西了！~~ 恨妳入骨的 Filbercio");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0602:
...
labelFunc031D_0621:
	...
	message("   向你致敬，地精部落酋長 Pomdirgun：~~ 讓你知道我們在這些地區的所有計劃都進展順利。我從狼( Wolves )那裡得知，他們計劃在新月第七天的清晨發動巡邏。~ 如果你伏擊了巡邏隊，那麼你就可以輕易地佔領幼鹿城塔本身。~ 狼( Wolves )將被嚴重削弱，而幼鹿城將在恐懼中顫抖！~ 但如果你能，請饒恕巡邏隊長一命。她是我君主最寵愛的人。~~ 我們懇求你不要讓這個信差落入我們的敵人，狼( Wolves )的手中。~~ Spektor，代表 Marsten 領主寫下");
	say();
	gflags[0x0093] = true;
	UI_set_item_flag(0xFFBB, 0x001D);
	gflags[0x0094] = true;
...
labelFunc031D_064E:
	...
	message("   向你致敬，地精部落酋長 Pomdirgun：~~ 讓你知道我們在這些地區的所有計劃都進展順利。從我們在幼鹿塔的成功經驗中學習後，我們決定在即將到來的第四個夜晚，盡可能地從公牛塔撤回軍隊。~ 熊( Bears )將向西行軍到平原上，並將輕易地被屠殺。~ 然後你就可以佔領塔樓，並掠奪睡牛旅店。~~ 我們想提醒你，絕對不要讓這個信差落入我們的敵人，狼( Wolves )和熊( Bears )的手中，這至關重要。~~ 蒙利多城領主 Marsten");
	say();
	gflags[0x0093] = true;
	UI_set_item_flag(0xFFBB, 0x001D);
	goto labelFunc031D_0A44;
...
labelFunc031D_0697:
	...
	message("美德 ----------------------------- ~ 寬容( Tolerance )、熱情( Enthusiasm )，以及情感( Emotion )道德( Ethicality )、紀律( Discipline )，以及邏輯( Logic ) ~ ----------------------------- ~~");
	say();
	message("反美德( Anti-Virtues ) ----------------------------- ~ 無序( Anarchy )、放縱( Wantonness )，以及瘋狂( Insanity )偏見( Prejudice )、冷漠( Apathy )，以及無情( Ruthlessness ) ~ ----------------------------- ");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_06AC:
	if (!(var0003 == 0x0087)) goto labelFunc031D_06C5;
	message("我，月影城( Moonshade )的商人 Purlonio ，即將講述我的故事。~~ 早在索沙利亞( Sosarian )殖民巨蛇之島的初期，我已經在城裡累積了——我必須告訴你——一筆龐大的財富。在做了一個極不尋常的夢之後，我尋求一位女巫的幫助。她收費昂貴，但給的建議很好也很正確。法師 Drogeni 警告我，在不久的將來，我即將失去我所有珍愛的財富，而且她無能為力阻止這件事發生。~");
	say();
...
labelFunc031D_0715:
	...
	message("親愛的");
	message(var0004);
	message("，~所有的預兆都表明，這次尋找巴特林的任務將嚴峻考驗你的能力。因此，我下令打開王國的軍械庫，以裝備你和你的優秀同伴們。~~你將會獲得這些物品 —— ~~玻璃劍( Glass Sword )，可以殺死任何敵人（但在這種屠殺的行為中會被摧毀）。~~法師剋星( MageBane )，你在之前與巴特林交手時找回的傳說武器。它會從反對你的法師那裡偷走魔法。~~你在美德鎔爐( Forge of Virtue )獲得的惡魔之劍( Daemon Sword )。這確實是一把可怕的武器，但你肯定會需要它。小心裡面的惡魔！");
	say();
	...
	say();
	message("~~一路平安，願惡棍巴特林很快落入你手中！此外，我希望你能盡快找到 Iolo 失蹤的妻子，善良的 Gwenno。~~~——你的君主，不列顛王。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_073A:
...
labelFunc031D_086C:
	...
	message("美之祭司( Priestess of Beauty )的儀式胸甲，也就是幼鹿城( Fawn )的 Kylista。我應該補充說，她是一位非常迷人的女士。");
	say();
labelFunc031D_0876:
...
labelFunc031D_0934:
	...
	message("被稱為石心( Stoneheart )的危險礦物，用於製造非法的魔法材料血菌絲( Bloodspawn )。");
	say();
labelFunc031D_093E:
	goto labelFunc031D_0A44;
labelFunc031D_0941:
...
labelFunc031D_0963:
	...
	message("這張證書賦予持有者最高一小時的偷竊權利。~~無序災厄( Anarch ) Shamino。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0974:
...
labelFunc031D_0985:
	...
	message("最親愛的聖者：~~ 我想打從心底恭喜你獲得了法術書。那可不是一件容易的事。你完成得非常令人欽佩。~ 還有，我聽說你在問關於我的問題。我想我會是解答你問題的最佳人選。也就是說，那些關於我自己的問題。~ 基於這些以及更多原因，我希望你能來我的莊園。 ~~Frigidazzi。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0996:
	if (!(var0003 == 0x00CC)) goto labelFunc031D_09A7;
	message("最親愛的聖者：~~ ~向你致以愛與敬意。讓你知道我等不及再次見到你了。我無法想像遠離你強壯的身體和英俊的容貌。你寬闊的肩膀和強壯的手臂對像我這樣的女人來說是多麼公開的邀請。你的眼睛，聖者，如此銳利卻又充滿愛意。在你上次來訪時，我能感受到那份愛。~ 我懇求你，今晚來拜訪我。你還記得我的莊園在哪裡，對吧？我有一個非常罕見的法術（一個真正的繞口令）可以教你，而你將是唯一一個享受我這珍貴法術的人。我再次懇求你，今晚一定要來，而且一定要自己一個人來。~~ 你的愛，      ~~Frigidazzi。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_09A7:
	if (!(var0003 == 0x00CD)) goto labelFunc031D_09B8;
	message("最親愛的聖者：~~ 我向你致以萬分歉意。我是導致你被捕的人，我無法原諒我自己。~ 你縈繞在我的夢中。關於你的記憶在我的眼前閃過，我能解決這場惡夢的唯一方法就是送你一份非常特別的禮物。~ 我懇求你收下這對巨蛇耳環( Serpent Earrings )，這是我對你愛慕的象徵，聖者。 ~~Frigidazzi。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_09B8:
...
labelFunc031D_09C9:
	...
	message("致高尚優秀的聖者：~~ 你一定不能認為你的任務已經完成了。因為我為你提供了一個巨大的挑戰。我把我的寶藏留給了你——如果你能找到的話。~ 在這批戰利品中有一頂巨蛇皇冠( Serpent Crown )，等待著你去發現它的藏身之處。~~Hawk 船長。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_09DA:
	if (!(var0003 == 0x00D0)) goto labelFunc031D_09EB;
	message("聖者：~~ 我擁有某件極具價值的東西，對你來說甚至更為重要。你可以好好利用它，相信我。~ 如果你有興趣（你應該要有興趣），到森林裡的小屋來。~~Stefano。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_09EB:
...
labelFunc031D_0A0D:
	...
	message("最親愛的聖者：~~ 向你致以愛與敬意。讓你知道我等不及再次見到你了。我無法想像遠離你強壯且善良的身體。~ 你的眼睛，聖者，如此銳利卻又充滿愛意。在你上次來訪時，我能感受到那份愛。我懇求你，今晚來拜訪我。~ 我有一個非常罕見的法術可以教你，而你將是唯一一個學習它的人。~ 我再次懇求你，今晚一定要來，而且一定要自己一個人來。~~ 你忠實的，\t~~Frigidazzi。");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0A1E:
	if (!(var0003 == 0x00D4)) goto labelFunc031D_0A2F;
	message("   我對我從幼鹿城( Fawn )那個無腦的統治者那裡拿來的梳子( Comb )有了一個最奇妙的發現！我再也不必被迫滿足於 Melino 那笨拙的關注了，我那可悲的丈夫！~ 因為把梳子用在自己身上後，我變得美麗且迷人！現在沒有人會猜到 Mosh 和我是雙胞胎了！現在我可以用我的智慧做更好的事情了…像是高階法師( Adept ) Torrissio！~~Columna");
	say();
	goto labelFunc031D_0A44;
labelFunc031D_0A2F:
