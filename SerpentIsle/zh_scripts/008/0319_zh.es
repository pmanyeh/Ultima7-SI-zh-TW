...
labelFunc0319_0088:
	...
	message("「這場惡夢實在讓人難以承受！連聖者本人都背叛了我！」~ 「守護者的卑劣行徑甚至腐蝕了我們最後的美德堡壘。失去了英雄，不列顛尼亞將會滅亡！我必須醒來…」");
	say();
	UI_remove_npc_face0();
...
labelFunc0319_00FF:
	...
	message("「你真的必須問我的名字嗎？難道你也像整個不列顛尼亞一樣遭受了最近的苦難？你認不出你的老朋友了嗎？」* 「是我，不列顛王，全不列顛尼亞的統治者。或者至少是經歷這些災難後所剩下的部分…」");
	say();
	UI_remove_answer("姓名");
	UI_add_answer(["災難"]);
labelFunc0319_011F:
...
labelFunc0319_013C:
	...
	message("「這當然是場夢！你還沒有從巨蛇之島回來。」~ 「有時候我擔心你永遠不會回來了…就在你啟航後不久，風暴就開始了。」");
	say();
	UI_remove_answer("夢");
	UI_add_answer("風暴");
labelFunc0319_0156:
...
labelFunc0319_01A3:
	...
	message("「我不知道它們是什麼意思…但不列顛尼亞的法師，似乎都無法預測最簡單法術的結果。」");
	say();
	UI_remove_answer("干擾");
	UI_add_answer("結果");
labelFunc0319_01BD:
	case "結果" attend labelFunc0319_01D7:
	message("「法師可能只是想用魔法點燃一根蠟燭，結果卻把整棟房子燒毀。或者另一位法師在同一時刻，卻發現自己無法用強大的火焰法術點燃一根蠟燭。」* 「法師們聲稱以太變得不穩定了…」");
	say();
	UI_remove_answer("結果");
	UI_add_answer("以太");
labelFunc0319_01D7:
	case "以太" attend labelFunc0319_01EA:
	message("「以太，就是法師們用來施展法術的能量。法師們說這種不穩定，是一個非常糟糕的預兆。」* 「據法師們說，這種失衡很容易摧毀世界——如果它繼續嚴重下去的話。」");
	say();
	UI_remove_answer("以太");
labelFunc0319_01EA:
	case "災難" attend labelFunc0319_020D:
	message("「如果只是奇怪的風暴，或者只是魔法的不穩定，我還不會那麼擔心。但當你把它和地震、森靈以及石像鬼聯繫起來時，我擔心世界真的要毀滅了。」");
	say();
	UI_remove_answer("災難");
...
labelFunc0319_023A:
	...
	message("「你應該還記得森靈吧，聖者。在我派你去尋找巨蛇之島之前，你拯救了他們的樹木。」~ 「我擔心這場大災難對他們的影響最為嚴重。」");
	say();
	UI_remove_answer("森靈");
	UI_add_answer("大災難");
labelFunc0319_0254:
...
labelFunc0319_026E:
	...
	message("「許多森靈已經死了。即使世界沒有自我毀滅，我也不抱太大希望這個溫和的種族，能有任何人存活下來。」~ 「我很確定，如果不採取措施阻止這些災難，疾病將會蔓延到人類身上。」");
	say();
	UI_remove_answer("疾病");
labelFunc0319_0281:
