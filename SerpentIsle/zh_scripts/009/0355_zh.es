...
labelFunc0355_0202:
	...
	message("「除非你帶上黑岩巨蛇(Serpent of Blackrock)，打開光之牆並引入來自虛空的能量，否則儀式無法成功。」");
	say();
...
labelFunc0355_021D:
	...
	UI_remove_answer("儀式");
	message("「你必須先打開光之牆，因為這能提供儀式所需的能量來源。這可以藉由將黑岩巨蛇放置在地板的石槽中來完成。」");
	say();
...
labelFunc0355_0271:
	...
	say();
	message("「如果沒有一股強大到足以將災禍融合進巨蛇的盟友力量，儀式就無法成功。修復比破壞是一項更艱鉅的任務。」");
	say();
