...
labelFunc04A8_0344:
	...
	say();
	message("「這是我舊房子後面保險庫的鑰匙，房子在城市西邊。有了它，你就能取回那個給我帶來這麼多麻煩的被詛咒的岩石巨蛇。帶著我的祝福收下它吧！」");
	say();
...
labelFunc04A8_037E:
	...
	UI_remove_answer("麻煩");
	message("「這一切都始於我為已故法師領主做的一份工作，內容涉及獲取一些絲襪…」");
	say();
...
labelFunc04A8_03AC:
	...
	say();
	message("「你一定能救我！幫我殺了他，你就會得到我最無價的獎賞！」");
	say();
...
labelFunc04A8_050C:
	...
	UI_remove_answer("自尊");
	message("「你根本不了解其中的一小部分！有一次我在藍野豬旅店打發時間， Frigidazzi 也在那裡。」");
	say();
