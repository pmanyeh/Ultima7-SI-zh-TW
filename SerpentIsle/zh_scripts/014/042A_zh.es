...
labelFunc042A_01A2:
	...
	message("「他現在自稱為無序災厄 Shamino( Shamino the Anarch )。」");
	say();
...
labelFunc042A_01BC:
	...
	message("「當無序災厄 Shamino 接管時，他把 Filbercio 趕出了宮殿，讓他成了一個乞丐。」");
	say();
	message("「不用說，這讓法師領主( MageLord )非常難以接受。 Filbercio 想跟你談談…也許身為 Shamino 的同伴，你能找到克服他力量的方法。」");
	say();
	message("「去街上找 Filbercio 吧，");
	message(var0000);
	message("。無序災厄 Shamino 已經下令，任何人都不准收留 Filbercio 或是以任何方式幫助他。」");
	say();
labelFunc042A_01DD:
