...
void Func02CF shape#(0x2CF) ()
{
	...
	if (!((event == 0x000A) || (event == 0x000B))) goto labelFunc02CF_0043;
	var0000 = Func090C(0xFE9C, item);
	var0001 = UI_execute_usecode_array(0xFE9C, [(byte)0x59, var0000, (byte)0x01, (byte)0x6C]);
	var0001 = UI_delayed_execute_usecode_array(item, [(byte)0x23, (byte)0x55, 0x02CF], 0x0002);
labelFunc02CF_0043:
	if (!(event == 0x0002)) goto labelFunc02CF_0102;
	var0002 = UI_find_nearest(0xFE9C, 0x02CF, 0x000A);
	...
	if (!var0001) goto labelFunc02CF_0102;
	if (!(UI_get_item_frame(item) == 0x0000)) goto labelFunc02CF_00CC;
	if (!(var0003 > 0x0000)) goto labelFunc02CF_00C9;
	UI_set_item_frame(var0002, (var0003 - 0x0001));
	UI_set_item_frame(item, 0x0001);
labelFunc02CF_00C9:
	goto labelFunc02CF_00F8;
labelFunc02CF_00CC:
	if (!(var0003 < 0x0003)) goto labelFunc02CF_00F8;
	UI_set_item_frame(var0002, (var0003 + 0x0001));
	if (!(UI_get_item_frame(item) < 0x0006)) goto labelFunc02CF_00F8;
