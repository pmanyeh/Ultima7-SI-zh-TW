...
labelFunc02C3_02EB:
	...
	message("不知密碼者，絕望吧！闖入者，這扇黃銅大門將阻斷你的前路，唯有知曉秘密密碼的人，才知道何時該使用符文！滾回你們那用刻板愚蠢堆砌的城市與秩序神殿吧，走狗！~當我躺在這裡、慢慢等死之際，我嘲笑著你們的命運！因為儘管我們的城市已經淪陷，笨蛋，你也休想把我的大門當作入侵的通道！就在這裡，在我們的城市中，你們的同類走狗正在為勝利狂歡，卻完全不知道我已經把他們死死封死在裡面了！~看啊！一位將軍正隔著黃銅大門向我揮舞拳頭，被困在裡面呢！不，秩序的走狗們，你們休想利用我的大門去向我的同胞發送金屬殺手！你們必須去使用巨蛇之門才能征服南方的土地！~我可以安詳地死去了。因為我知道，即便我的家園已成廢墟，屬於我們的混沌之城如今落入敵人之手，我的大門也將永遠緊閉，直達永恆！");
	say();
	goto labelFunc02C3_043B;
labelFunc02C3_02FC:
...
labelFunc02C3_0375:
	...
	say();
	message("~  第二步：必須將每個被囚禁的災星（Bane）放在與其原則相對應的祭壇上。不受約束的情感（Emotion）會導致瘋狂（Madness）。不受控制的熱情（Enthusiasm）會導致放縱（Wantonness）。不假思索的寬容（Tolerance）會產生無序狀態（Anarchy）。混沌之焰（Flame of Chaos）將歡迎每個災星來到其適當的位置。");
	say();
...
labelFunc02C3_0396:
	...
	say();
	message("~\t我們遠遠好過那些讓無序狀態控制他們生活和思想的人。我們必須永遠保持警惕，以確保我們的道德體系堅如磐石，它絕不能從內部被腐蝕。我們必須確保我們保持純潔，因為腐敗是我們敵人的力量，儘管如果我們團結一致對抗它，它將會毀滅它自己。");
	say();
	message("~\t道德（Ethicality）的學徒，注意了！你必須比你現在更強大，才能抵抗混沌誘惑你的虛假真理。就像鐵在鍛造爐中一樣，你將受到混沌和腐敗洪流的衝擊，直到你失去脆性並硬化成力量的核心。透過道德，你可以擺脫隱藏在混沌和無知中的無序狀態和痛苦。");
	say();
	goto labelFunc02C3_043B;
labelFunc02C3_03B3:
	if (!(var0000 == 0x0079)) goto labelFunc02C3_03D4;
	message("~教主圖書館（Library of the Hierophant） ~~ \t教主大圖書館包含了定義和指導秩序（Order）追隨者的所有歷史和知識。儘管它隱藏在山的深處，但秩序的學徒可以透過教主神廟（Temple of the Hierophant）的傳送門進入它。");
	say();
	message("~\t在災難和戰爭時期，大圖書館被封閉，以防止其珍貴的作品被摧毀，或落入混沌之手。進入圖書館意味著首先要打開通往教主神廟的門。");
	say();
	message("~ 只有學徒在神廟門前的基座上放置正確的秩序符號才能實現。由於只有真正的秩序追隨者才了解這些符號，這是防止混沌的人褻瀆神廟和圖書館的第一個測試。\t只有研究過秩序的作家和詩人的人，才會有智慧和知識打開這扇門。");
	say();
	message("~\t一旦門打開，學徒就需要教主權杖（Sceptre of the Hierophant）才能進入圖書館。由於教主負責保管它，只有徵得他的同意才能進入。如果權杖遺失，或者教主在戰鬥中陣亡，圖書館將永遠關閉，遠離混沌的腐敗。");
	say();
	message("~\t學徒手持權杖，必須站在神廟的藍色基座前。他必須把權杖放在基座的頂部。然後學徒將立即獲得進入圖書館的權限。秩序（Order）的所有知識都被保存在那裡，作為對抗腐敗和混沌的堡壘。");
	say();
	goto labelFunc02C3_043B;
labelFunc02C3_03D4:
