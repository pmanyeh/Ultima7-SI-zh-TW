...
labelFunc0614_008C:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「他在這裡的任務已經完成。他現在可以前往虛空了。」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_00AC:
...
labelFunc0614_010C:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「當你獲得大祭司的三大神器：巨蛇之杖、巨蛇盔甲和巨蛇皇冠時再回來。」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_012C:
...
labelFunc0614_014C:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「你處於平衡之中，同時掌握了混沌與秩序。我宣布你配得上佩戴平衡大祭司的徽記。」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_016C:
...
labelFunc0614_018C:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「殺了我！用蛇神之劍殺了我，將我的靈魂送回虛空！」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_01AC:
...
labelFunc0614_028C:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「你是誰，陌生人？為什麼我看不見你？詛咒這遮蔽了我心智的失衡…」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_02AC:
...
labelFunc0614_02CC:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「來自異世界的英雄！須知我就是偉大的大地巨蛇，在毀滅者 Exodus 的時代你將我從囚禁中解放出來。要是你現在能幫助我該有多好，聖者。」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_02EC:
	...
	UI_show_npc_face(var0002, 0x0000);
	message("「尋找那支猿怪(Gwani)號角…在碎骨者山脈下方的深處尋找它。」");
	say();
	UI_remove_npc_face(var0002);
	return;
labelFunc0614_030C:
...
labelFunc0614_0374:
	...
	UI_show_npc_face(0xFF00, 0x0000);
	message("「我已經向你還清了我的債，我們的交易也結束了。我不會再幫助你了。小心混沌災厄，聖者！」");
	say();
	UI_remove_npc_face(0xFF00);
	return;
labelFunc0614_0394:
	...
	message("「聖者！是我， Dupre ！我的靈魂已經與混沌巨蛇融合。我正阻止它攻擊你，但我不知道我還能撐多久！快！你必須去晨曦島！」");
	say();
...
labelFunc0614_03B4:
	...
	message("「你以為你能將秩序巨蛇鎖在平衡的監獄裡嗎？絕不！秩序的侍從們，進攻！」");
	say();
