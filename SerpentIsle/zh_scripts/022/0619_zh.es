...
labelFunc0619_014A:
	...
	say();
	message("「要知道，即使是那些愚昧的白痴，那些蛇神教徒也在等待著你。所以這對你來說不應該是個打擊。」");
	say();
	UI_add_answer("愚昧的白痴");
labelFunc0619_0168:
...
labelFunc0619_018A:
	...
	message("「你這小傢伙，問題還真多啊？好啦，親愛的，老 Drusilla 可沒空站這兒跟你大聊特聊什麼大道理。你自己也該去忙你的正事了。」");
	say();
	message("「我們這些追隨引導者的人，從不主動招攬信徒。我們自己要忙的事多著呢。要是你做完自己的事還想找我聊，嗯…也許之後會有時間吧。」");
	say();
labelFunc0619_01A1:
	case "有用的東西" attend labelFunc0619_01B4:
	UI_remove_answer("有用的東西");
	message("「好啦，親愛的，要是我現在就告訴你那是啥，不就掃了你的興嗎？所以啊，你自己回去好好親眼瞧瞧吧。」");
	say();
labelFunc0619_01B4:
	case "重要東西" attend labelFunc0619_01C7:
	UI_remove_answer("重要東西");
	message("「我不能把所有事情都告訴你，親愛的。如果你要成為預言的棋子，你就得自己想辦法弄明白。」");
	say();
labelFunc0619_01C7:
	case "貓咪生物" attend labelFunc0619_01DA:
	UI_remove_answer("貓咪生物");
	message("「我真不懂你怎麼會錯過牠。那個可憐的小東西被嚇得半死…我敢打賭牠也餓了。你完全可以對這麼一個可憐的生物友好一些。」");
	say();
labelFunc0619_01DA:
