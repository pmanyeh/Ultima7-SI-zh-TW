...
void Func0204 shape#(0x204) ()
{
	...
	if (!((event != 0x0001) && (event != 0x0002))) goto labelFunc0204_000F;
	return;
labelFunc0204_000F:
	var0000 = Func0906(item);
	if (!(var0000 == 0x0001)) goto labelFunc0204_0067;
	if (!Func0908(item, 0x00E1, 0x0000, 0x0000, 0x0003, 0x0001)) goto labelFunc0204_0064;
	...
	goto labelFunc0204_0067;
labelFunc0204_0064:
	Func0903();
labelFunc0204_0067:
	if (!(var0000 == 0x0000)) goto labelFunc0204_00B8;
	if (!Func0908(item, 0x00E1, 0x0001, 0xFFFD, 0x0000, 0x0007)) goto labelFunc0204_00B5;
	Func0902(item, 0x0204);
	Func0909(item, 0x00F6, 0x0000, 0x0001, 0x01D7, 0x0001, 0x0000, 0x0000, 0x0007);
	UI_play_sound_effect2(0x006A, item);
	goto labelFunc0204_00B8;
labelFunc0204_00B5:
	Func0903();
labelFunc0204_00B8:
	if (!(var0000 == 0x0002)) goto labelFunc0204_00C6;
	Func0904(item);
labelFunc0204_00C6:
	if (!(var0000 == 0x0003)) goto labelFunc0204_00D4;
	Func0905(item);
labelFunc0204_00D4:
	return;
}
