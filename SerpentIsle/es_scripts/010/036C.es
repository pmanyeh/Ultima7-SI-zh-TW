...
void Func036C shape#(0x36C) ()
{
	...
	if (!(event == 0x0002)) goto labelFunc036C_00AA;
	var0000 = UI_get_object_position(item);
	var0001 = UI_get_item_quality(item);
	var0002 = UI_get_item_frame(item);
	if (!(var0002 == 0x0000)) goto labelFunc036C_0033;
	var0002 = 0x0000;
	goto labelFunc036C_004C;
labelFunc036C_0033:
	if (!(var0002 == 0x0002)) goto labelFunc036C_0046;
	var0002 = 0x000A;
	goto labelFunc036C_004C;
labelFunc036C_0046:
	var0002 = 0x0005;
