...
void Func08C5 0x8C5 ()
{
	...
	enum();
labelFunc08C5_0008:
	for (var0003 in var0000 with var0001 to var0002) attend labelFunc08C5_0062;
	var0004 = UI_die_roll(0x0001, 0x0005);
	var0005 = 0x0000;
	var0006 = UI_die_roll(0x0000, 0x0001);
	if (!var0006) goto labelFunc08C5_0042;
	var0005 = 0x0002;
	goto labelFunc08C5_0048;
labelFunc08C5_0042:
	var0005 = 0x0004;
labelFunc08C5_0048:
	var0007 = UI_execute_usecode_array(var0003, [(byte)0x27, var0004, (byte)0x59, var0005]);
	goto labelFunc08C5_0008;
labelFunc08C5_0062:
	return;
}
